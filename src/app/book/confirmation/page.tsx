  ...
  return (
    <div className="max-w-lg mx-auto px-4 text-center">
      ...
      <motion.div
        ...
        className="bg-gold/5 border border-gold/20 rounded-lg p-6 mb-8 text-left"
      >
        <div className="flex items-start gap-4">
          ...
          <div className="flex-1">
            ...
            <p className="text-gray-400 text-xs leading-relaxed mb-3">
              Please complete your client intake and consent form before your
              appointment. It only takes a few minutes and can be done online.
            </p>
            <Link
              href="/consent"
              className="inline-flex items-center gap-1.5 text-gold text-xs font-semibold uppercase tracking-widest hover:text-gold-light transition-colors duration-200"
            >
