    ...
    <footer className="bg-dark border-t border-gold/20">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
          {/* Column 1: Brand */}
          <div>
            <h3 className="font-heading text-2xl font-bold bg-gold-gradient bg-clip-text text-transparent mb-4">
              Velvet Brow Studio
            </h3>
          ...
          <div>
            ...
            <ul className="space-y-3">
              ...
              <li>
                <Link
                  href="/book"
                  className="text-gold text-sm font-semibold hover:text-gold-light transition-colors duration-300"
                >
                  Book Now
                </Link>
              </li>
          ...
          <div>
            ...
            <form onSubmit={handleSubscribe} className="space-y-3">
              <input
                ...
                required
                className="w-full bg-dark-light border border-dark-lighter rounded px-4 py-3 text-white placeholder-gray-500 text-sm transition-all duration-300 focus:outline-none focus:border-gold focus:ring-1 focus:ring-gold/30"
              />
              <button
                type="submit"
      ...
      <div className="border-t border-dark-lighter">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6 flex flex-col md:flex-row items-center justify-between gap-4">
          ...
          <p className="text-gray-500 text-xs text-center">
            &copy; {currentYear} Velvet Brow Studio. All rights reserved.
          </p>
        </div>
      </div>
    </footer>
