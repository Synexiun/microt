...
const navItems = [
  ...
  },
  {
    ...
    icon: (
      <svg className="w-5 h-5" fill="none" viewBox="0 0 24 24" stroke="currentColor" strokeWidth={1.5}>
        <path strokeLinecap="round" strokeLinejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909M2.25 15.75V18a2.25 2.25 0 002.25 2.25h15A2.25 2.25 0 0021.75 18v-2.25m-18 0V6a2.25 2.25 0 012.25-2.25h13.5A2.25 2.25 0 0121.75 6v9.75" />
      </svg>
    ),
  },
  {
...
export default function AdminSidebar({ open, onClose }: AdminSidebarProps) {
  ...
  return (
    <>
      {/* Desktop sidebar */}
      <aside className="hidden lg:flex flex-col fixed left-0 top-0 bottom-0 w-[260px] bg-dark-light border-r border-dark-lighter z-40">
        {sidebarContent}
      </aside>
      ...
      {open && (
        <div className="lg:hidden fixed inset-0 z-50">
          <div
            ...
            onClick={onClose}
          />
          <aside className="absolute left-0 top-0 bottom-0 w-[260px] bg-dark-light border-r border-dark-lighter animate-slideIn">
            {sidebarContent}
          </aside>
        </div>
      )}
